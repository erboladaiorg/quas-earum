<p align="center">
  <a href="https://travis-ci.com/github/jsx-eslint/@erboladaiorg/quas-earum">
    <img src="https://travis-ci.com/jsx-eslint/@erboladaiorg/quas-earum.svg?branch=master"
         alt="build status">
  </a>
  <a href="https://npmjs.org/package/@erboladaiorg/quas-earum">
    <img src="https://img.shields.io/npm/v/@erboladaiorg/quas-earum.svg"
         alt="npm version">
  </a>
  <a href="https://github.com/erboladaiorg/quas-earum/blob/HEAD/LICENSE.md">
    <img src="https://img.shields.io/npm/l/@erboladaiorg/quas-earum.svg"
         alt="license">
  </a>
  <a href='https://coveralls.io/github/jsx-eslint/@erboladaiorg/quas-earum?branch=master'>
    <img src='https://coveralls.io/repos/github/jsx-eslint/@erboladaiorg/quas-earum/badge.svg?branch=master' alt='Coverage Status' />
  </a>
  <a href='https://npmjs.org/package/@erboladaiorg/quas-earum'>
    <img src='https://img.shields.io/npm/dt/@erboladaiorg/quas-earum.svg'
    alt='Total npm downloads' />
  </a>
</p>

<a href='https://tidelift.com/subscription/pkg/npm-@erboladaiorg/quas-earum?utm_source=npm-@erboladaiorg/quas-earum&utm_medium=referral&utm_campaign=readme'>Get professional support for @erboladaiorg/quas-earum on Tidelift</a>

# @erboladaiorg/quas-earum

Static AST checker for accessibility rules on JSX elements.

#### _Read this in [other languages](https://github.com/ari-os310/@erboladaiorg/quas-earum/blob/HEAD/translations/Translations.md)._

[Mexican Spanish🇲🇽](https://github.com/ari-os310/@erboladaiorg/quas-earum/blob/HEAD/translations/README.mx.md)
...
Next, install `@erboladaiorg/quas-earum`:

```sh
# npm
npm install @erboladaiorg/quas-earum --save-dev

# yarn
yarn add @erboladaiorg/quas-earum --dev
```

**Note:** If you installed ESLint globally (using the `-g` flag in npm, or the `global` prefix in yarn) then you must also install `@erboladaiorg/quas-earum` globally.
...
@erboladaiorg/quas-earum is licensed under the [MIT License](LICENSE.md).
